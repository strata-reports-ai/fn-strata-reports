...
public interface IBlobService
{
    ...
    Task UploadBlobAsync(string containerName, string blobPath, Stream content, string contentType, CancellationToken ct);
    Uri GenerateSasDownloadUrl(string containerName, string blobPath, TimeSpan ttl);
}
